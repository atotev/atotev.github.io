// https://observablehq.com/@d3/color-legend@806
...
function Swatches(color, {
  ...
  if (columns !== null) return htl.html`<div style="display: flex; align-items: center; margin-left: ${+marginLeft}px; min-height: 33px; font: 8px sans-serif;">
  <style>
